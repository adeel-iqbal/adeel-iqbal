...
Curious mind chasing intelligence through code. I love solving real problems and building things that make a difference. Now exploring GenAI and Agentic AI to take that creativity even further.

When I’m off-screen, I’m either playing chess ♟️, lifting weights 💪, scoring goals in FIFA ⚽, or getting lost in a good book 📚.
...
[![LangChain](https://img.shields.io/badge/LangChain-1C3C3C?logo=langchain&logoColor=fff)](#) [![RAG](https://img.shields.io/badge/RAG%20Pipelines-7C3AED?logo=openai&logoColor=fff)](#) [![n8n](https://img.shields.io/badge/n8n-EA4B8B?logo=n8n&logoColor=fff)](#)
